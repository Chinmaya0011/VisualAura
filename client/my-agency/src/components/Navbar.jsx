    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">VisualAura</span>
        </Link>
        <button
          onClick={toggleMenu}
          type="button"
        ...
        <div className={`w-full md:block md:w-auto ${isOpen ? 'block' : 'hidden'} max-h-60 overflow-y-auto`} id="navbar-default">
