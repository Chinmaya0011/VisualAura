...
const Gadgets = () => {
  ...
  // Filter blogs by Gadgets category
  useEffect(() => {
    const gadgetsBlogs = blogs.filter((blog) => blog.category === "Gadgets");
    setFilteredBlogs(gadgetsBlogs);
  }, [blogs]);
          ...
          {filteredBlogs.length === 0 ? (
            ...
            filteredBlogs.map((blog) => (
              ...
              >
                ...
                >
                  <h2 className="text-2xl font-semibold mb-4 text-teal-900 tracking-wide">
                    {blog.title}
                  </h2>

                  <div className="text-sm text-gray-600 mb-4 italic">
                    <span className="font-semibold text-teal-600">{blog.author}</span> |
                  ...
                  <Link
                    to={`/blog/${blog._id}`}
                    className="text-teal-500 hover:text-teal-700 font-semibold text-lg flex items-center space-x-2 transform transition-all duration-300"
