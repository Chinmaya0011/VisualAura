...
const Footer = () => {
  ...
  return (
    <>
      <Helmet>
        <title>VisualAura - Digital Solutions</title>
        <meta name="description" content="VisualAura provides digital solutions for web development, mobile app design, and more!" />
        <meta name="keywords" content="web development, mobile apps, digital solutions, VisualAura" />
        <meta name="author" content="Chinmaya" />
      </Helmet>
